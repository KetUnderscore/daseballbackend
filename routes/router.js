...
ops:(Math.round(((Math.round(((playerData[x].hitsgot+playerData[x].walksgot)/playerData[x].atbats)*100)/100)+(Math.round((playerData[x].basesReached/players ta[x].atbats)*100)/100))*100)/100)))
}
